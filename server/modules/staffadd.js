...
exports.postData = (req, res) => {
  ...
  con.connect((err) => {
    ...
    const sql = "INSERT INTO m_staff (id, name, gender, position, joining_day, birthday, age, school_career, phone_number, near_station, company_id, area_id, occupation_id, employment_system_id, entry_at, update_at, update_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
